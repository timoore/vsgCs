...
namespace vsgCs
{
    ...
    protected:
        ...
        static constexpr const double forever = std::numeric_limits<double>::max();
        ...
        virtual bool handleKeyboardAction(const Action& action, vsg::time_point time,
                                          double duration_s = forever);
        virtual bool handleScrollAction(const Action& action, vsg::time_point time,
                                        double duration_s = forever);
        ...
        vsg::observer_ptr<WorldNode> _mapNode;
        vsg::ref_ptr<vsg::Camera> _camera;
        vsg::ref_ptr<IGeospatialServices> _geoServices;

        std::optional<vsg::MoveEvent> _currentMove, _previousMove;
        std::optional<vsg::ButtonPressEvent> _buttonPress;
        std::optional<vsg::ButtonReleaseEvent> _buttonRelease;
        std::optional<vsg::KeyPressEvent> _keyPress;
